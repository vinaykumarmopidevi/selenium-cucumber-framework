...
public class SearchSteps {
    ...
    public void searchProductLinkWithDataIsDisplayed(String data) {
        ...
        if(dataLowerCase.equals("samsung")){
            Assert.assertEquals("samsung leather cover for samsung galaxy fold", actualSearchProductLink);
        }

        if(dataLowerCase.equals("apple")){
            Assert.assertEquals("apple applecare protection plan for macbook air (m2)", actualSearchProductLink);
        }
    }
